...
// IsSuccess returns true when this get team groups Api o k response has a 2xx status code
func (o *GetTeamGroupsAPIOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get team groups Api o k response has a 3xx status code
func (o *GetTeamGroupsAPIOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get team groups Api o k response has a 4xx status code
func (o *GetTeamGroupsAPIOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get team groups Api o k response has a 5xx status code
func (o *GetTeamGroupsAPIOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get team groups Api o k response a status code equal to that given
func (o *GetTeamGroupsAPIOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get team groups Api o k response
