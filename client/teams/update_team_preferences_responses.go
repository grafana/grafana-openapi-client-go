...
// IsSuccess returns true when this update team preferences o k response has a 2xx status code
func (o *UpdateTeamPreferencesOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update team preferences o k response has a 3xx status code
func (o *UpdateTeamPreferencesOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update team preferences o k response has a 4xx status code
func (o *UpdateTeamPreferencesOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this update team preferences o k response has a 5xx status code
func (o *UpdateTeamPreferencesOK) IsServerError() bool {
	return false
}

// IsCode returns true when this update team preferences o k response a status code equal to that given
func (o *UpdateTeamPreferencesOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the update team preferences o k response
