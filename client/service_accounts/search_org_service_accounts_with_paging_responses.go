...
// IsSuccess returns true when this search org service accounts with paging o k response has a 2xx status code
func (o *SearchOrgServiceAccountsWithPagingOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this search org service accounts with paging o k response has a 3xx status code
func (o *SearchOrgServiceAccountsWithPagingOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this search org service accounts with paging o k response has a 4xx status code
func (o *SearchOrgServiceAccountsWithPagingOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this search org service accounts with paging o k response has a 5xx status code
func (o *SearchOrgServiceAccountsWithPagingOK) IsServerError() bool {
	return false
}

// IsCode returns true when this search org service accounts with paging o k response a status code equal to that given
func (o *SearchOrgServiceAccountsWithPagingOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the search org service accounts with paging o k response
