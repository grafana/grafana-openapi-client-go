...
// IsSuccess returns true when this unstar dashboard by Uid o k response has a 2xx status code
func (o *UnstarDashboardByUIDOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this unstar dashboard by Uid o k response has a 3xx status code
func (o *UnstarDashboardByUIDOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this unstar dashboard by Uid o k response has a 4xx status code
func (o *UnstarDashboardByUIDOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this unstar dashboard by Uid o k response has a 5xx status code
func (o *UnstarDashboardByUIDOK) IsServerError() bool {
	return false
}

// IsCode returns true when this unstar dashboard by Uid o k response a status code equal to that given
func (o *UnstarDashboardByUIDOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the unstar dashboard by Uid o k response
