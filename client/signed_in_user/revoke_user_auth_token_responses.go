...
// IsSuccess returns true when this revoke user auth token o k response has a 2xx status code
func (o *RevokeUserAuthTokenOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this revoke user auth token o k response has a 3xx status code
func (o *RevokeUserAuthTokenOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this revoke user auth token o k response has a 4xx status code
func (o *RevokeUserAuthTokenOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this revoke user auth token o k response has a 5xx status code
func (o *RevokeUserAuthTokenOK) IsServerError() bool {
	return false
}

// IsCode returns true when this revoke user auth token o k response a status code equal to that given
func (o *RevokeUserAuthTokenOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the revoke user auth token o k response
