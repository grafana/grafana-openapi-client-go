...
// IsSuccess returns true when this get current org quota o k response has a 2xx status code
func (o *GetCurrentOrgQuotaOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get current org quota o k response has a 3xx status code
func (o *GetCurrentOrgQuotaOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get current org quota o k response has a 4xx status code
func (o *GetCurrentOrgQuotaOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get current org quota o k response has a 5xx status code
func (o *GetCurrentOrgQuotaOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get current org quota o k response a status code equal to that given
func (o *GetCurrentOrgQuotaOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get current org quota o k response
