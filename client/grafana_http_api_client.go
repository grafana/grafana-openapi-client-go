...
func New(transport runtime.ClientTransport, cfg *TransportConfig, formats strfmt.Registry) *GrafanaHTTPAPI {
	...
	cli.AccessControl = access_control.New(transport, formats, clientConfig)
	cli.AccessControlProvisioning = access_control_provisioning.New(transport, formats, clientConfig)
	cli.Admin = admin.New(transport, formats, clientConfig)
	cli.AdminLdap = admin_ldap.New(transport, formats, clientConfig)
	cli.AdminProvisioning = admin_provisioning.New(transport, formats, clientConfig)
	cli.AdminUsers = admin_users.New(transport, formats, clientConfig)
	cli.Annotations = annotations.New(transport, formats, clientConfig)
	cli.APIKeys = api_keys.New(transport, formats, clientConfig)
	cli.Correlations = correlations.New(transport, formats, clientConfig)
	cli.DashboardPermissions = dashboard_permissions.New(transport, formats, clientConfig)
	cli.DashboardVersions = dashboard_versions.New(transport, formats, clientConfig)
	cli.Dashboards = dashboards.New(transport, formats, clientConfig)
	cli.DatasourcePermissions = datasource_permissions.New(transport, formats, clientConfig)
	cli.Datasources = datasources.New(transport, formats, clientConfig)
	cli.Ds = ds.New(transport, formats, clientConfig)
	cli.Enterprise = enterprise.New(transport, formats, clientConfig)
	cli.FolderPermissions = folder_permissions.New(transport, formats, clientConfig)
	cli.Folders = folders.New(transport, formats, clientConfig)
	cli.GetCurrentOrg = get_current_org.New(transport, formats, clientConfig)
	cli.LdapDebug = ldap_debug.New(transport, formats, clientConfig)
	cli.LegacyAlerts = legacy_alerts.New(transport, formats, clientConfig)
	cli.LegacyAlertsNotificationChannels = legacy_alerts_notification_channels.New(transport, formats, clientConfig)
	cli.LibraryElements = library_elements.New(transport, formats, clientConfig)
	cli.Licensing = licensing.New(transport, formats, clientConfig)
	cli.Org = org.New(transport, formats, clientConfig)
	cli.OrgInvites = org_invites.New(transport, formats, clientConfig)
	cli.OrgPreferences = org_preferences.New(transport, formats, clientConfig)
	cli.Orgs = orgs.New(transport, formats, clientConfig)
	cli.Playlists = playlists.New(transport, formats, clientConfig)
	cli.Provisioning = provisioning.New(transport, formats, clientConfig)
	cli.QueryHistory = query_history.New(transport, formats, clientConfig)
	cli.RecordingRules = recording_rules.New(transport, formats, clientConfig)
	cli.Reports = reports.New(transport, formats, clientConfig)
	cli.Saml = saml.New(transport, formats, clientConfig)
	cli.Search = search.New(transport, formats, clientConfig)
	cli.ServiceAccounts = service_accounts.New(transport, formats, clientConfig)
	cli.SignedInUser = signed_in_user.New(transport, formats, clientConfig)
	cli.Snapshots = snapshots.New(transport, formats, clientConfig)
	cli.SyncTeamGroups = sync_team_groups.New(transport, formats, clientConfig)
	cli.Teams = teams.New(transport, formats, clientConfig)
	cli.UserPreferences = user_preferences.New(transport, formats, clientConfig)
	cli.Users = users.New(transport, formats, clientConfig)
	return cli
}
