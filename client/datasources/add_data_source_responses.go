...
// IsSuccess returns true when this add data source o k response has a 2xx status code
func (o *AddDataSourceOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this add data source o k response has a 3xx status code
func (o *AddDataSourceOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this add data source o k response has a 4xx status code
func (o *AddDataSourceOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this add data source o k response has a 5xx status code
func (o *AddDataSourceOK) IsServerError() bool {
	return false
}

// IsCode returns true when this add data source o k response a status code equal to that given
func (o *AddDataSourceOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the add data source o k response
