...
// IsSuccess returns true when this delete data source by Id o k response has a 2xx status code
func (o *DeleteDataSourceByIDOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this delete data source by Id o k response has a 3xx status code
func (o *DeleteDataSourceByIDOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete data source by Id o k response has a 4xx status code
func (o *DeleteDataSourceByIDOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete data source by Id o k response has a 5xx status code
func (o *DeleteDataSourceByIDOK) IsServerError() bool {
	return false
}

// IsCode returns true when this delete data source by Id o k response a status code equal to that given
func (o *DeleteDataSourceByIDOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the delete data source by Id o k response
