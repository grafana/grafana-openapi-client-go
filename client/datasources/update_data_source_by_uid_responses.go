...
// IsSuccess returns true when this update data source by Uid o k response has a 2xx status code
func (o *UpdateDataSourceByUIDOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update data source by Uid o k response has a 3xx status code
func (o *UpdateDataSourceByUIDOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update data source by Uid o k response has a 4xx status code
func (o *UpdateDataSourceByUIDOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this update data source by Uid o k response has a 5xx status code
func (o *UpdateDataSourceByUIDOK) IsServerError() bool {
	return false
}

// IsCode returns true when this update data source by Uid o k response a status code equal to that given
func (o *UpdateDataSourceByUIDOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the update data source by Uid o k response
