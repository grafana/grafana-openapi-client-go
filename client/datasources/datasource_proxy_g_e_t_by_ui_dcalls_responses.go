...
// IsSuccess returns true when this datasource proxy g e t by Ui dcalls o k response has a 2xx status code
func (o *DatasourceProxyGETByUIDcallsOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this datasource proxy g e t by Ui dcalls o k response has a 3xx status code
func (o *DatasourceProxyGETByUIDcallsOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this datasource proxy g e t by Ui dcalls o k response has a 4xx status code
func (o *DatasourceProxyGETByUIDcallsOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this datasource proxy g e t by Ui dcalls o k response has a 5xx status code
func (o *DatasourceProxyGETByUIDcallsOK) IsServerError() bool {
	return false
}

// IsCode returns true when this datasource proxy g e t by Ui dcalls o k response a status code equal to that given
func (o *DatasourceProxyGETByUIDcallsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the datasource proxy g e t by Ui dcalls o k response
