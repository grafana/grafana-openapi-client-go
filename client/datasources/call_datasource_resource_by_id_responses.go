...
// IsSuccess returns true when this call datasource resource by Id o k response has a 2xx status code
func (o *CallDatasourceResourceByIDOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this call datasource resource by Id o k response has a 3xx status code
func (o *CallDatasourceResourceByIDOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this call datasource resource by Id o k response has a 4xx status code
func (o *CallDatasourceResourceByIDOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this call datasource resource by Id o k response has a 5xx status code
func (o *CallDatasourceResourceByIDOK) IsServerError() bool {
	return false
}

// IsCode returns true when this call datasource resource by Id o k response a status code equal to that given
func (o *CallDatasourceResourceByIDOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the call datasource resource by Id o k response
