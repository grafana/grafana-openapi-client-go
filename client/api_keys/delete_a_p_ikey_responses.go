...
// IsSuccess returns true when this delete a p ikey o k response has a 2xx status code
func (o *DeleteAPIkeyOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this delete a p ikey o k response has a 3xx status code
func (o *DeleteAPIkeyOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete a p ikey o k response has a 4xx status code
func (o *DeleteAPIkeyOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete a p ikey o k response has a 5xx status code
func (o *DeleteAPIkeyOK) IsServerError() bool {
	return false
}

// IsCode returns true when this delete a p ikey o k response a status code equal to that given
func (o *DeleteAPIkeyOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the delete a p ikey o k response
