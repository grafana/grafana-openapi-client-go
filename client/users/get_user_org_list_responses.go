...
// IsSuccess returns true when this get user org list o k response has a 2xx status code
func (o *GetUserOrgListOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get user org list o k response has a 3xx status code
func (o *GetUserOrgListOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get user org list o k response has a 4xx status code
func (o *GetUserOrgListOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get user org list o k response has a 5xx status code
func (o *GetUserOrgListOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get user org list o k response a status code equal to that given
func (o *GetUserOrgListOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get user org list o k response
