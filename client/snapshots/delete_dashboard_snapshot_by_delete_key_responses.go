...
// IsSuccess returns true when this delete dashboard snapshot by delete key o k response has a 2xx status code
func (o *DeleteDashboardSnapshotByDeleteKeyOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this delete dashboard snapshot by delete key o k response has a 3xx status code
func (o *DeleteDashboardSnapshotByDeleteKeyOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete dashboard snapshot by delete key o k response has a 4xx status code
func (o *DeleteDashboardSnapshotByDeleteKeyOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete dashboard snapshot by delete key o k response has a 5xx status code
func (o *DeleteDashboardSnapshotByDeleteKeyOK) IsServerError() bool {
	return false
}

// IsCode returns true when this delete dashboard snapshot by delete key o k response a status code equal to that given
func (o *DeleteDashboardSnapshotByDeleteKeyOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the delete dashboard snapshot by delete key o k response
