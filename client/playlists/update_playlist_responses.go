...
// IsSuccess returns true when this update playlist o k response has a 2xx status code
func (o *UpdatePlaylistOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this update playlist o k response has a 3xx status code
func (o *UpdatePlaylistOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this update playlist o k response has a 4xx status code
func (o *UpdatePlaylistOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this update playlist o k response has a 5xx status code
func (o *UpdatePlaylistOK) IsServerError() bool {
	return false
}

// IsCode returns true when this update playlist o k response a status code equal to that given
func (o *UpdatePlaylistOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the update playlist o k response
