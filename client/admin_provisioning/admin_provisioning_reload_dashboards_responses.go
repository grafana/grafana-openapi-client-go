...
// IsSuccess returns true when this admin provisioning reload dashboards o k response has a 2xx status code
func (o *AdminProvisioningReloadDashboardsOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this admin provisioning reload dashboards o k response has a 3xx status code
func (o *AdminProvisioningReloadDashboardsOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this admin provisioning reload dashboards o k response has a 4xx status code
func (o *AdminProvisioningReloadDashboardsOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this admin provisioning reload dashboards o k response has a 5xx status code
func (o *AdminProvisioningReloadDashboardsOK) IsServerError() bool {
	return false
}

// IsCode returns true when this admin provisioning reload dashboards o k response a status code equal to that given
func (o *AdminProvisioningReloadDashboardsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the admin provisioning reload dashboards o k response
