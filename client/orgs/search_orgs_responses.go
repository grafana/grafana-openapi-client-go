...
// IsSuccess returns true when this search orgs o k response has a 2xx status code
func (o *SearchOrgsOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this search orgs o k response has a 3xx status code
func (o *SearchOrgsOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this search orgs o k response has a 4xx status code
func (o *SearchOrgsOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this search orgs o k response has a 5xx status code
func (o *SearchOrgsOK) IsServerError() bool {
	return false
}

// IsCode returns true when this search orgs o k response a status code equal to that given
func (o *SearchOrgsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the search orgs o k response
