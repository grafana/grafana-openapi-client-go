...
// IsSuccess returns true when this post dashboard o k response has a 2xx status code
func (o *PostDashboardOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this post dashboard o k response has a 3xx status code
func (o *PostDashboardOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post dashboard o k response has a 4xx status code
func (o *PostDashboardOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this post dashboard o k response has a 5xx status code
func (o *PostDashboardOK) IsServerError() bool {
	return false
}

// IsCode returns true when this post dashboard o k response a status code equal to that given
func (o *PostDashboardOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the post dashboard o k response
