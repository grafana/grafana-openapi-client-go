...
// IsSuccess returns true when this delete dashboard by Uid o k response has a 2xx status code
func (o *DeleteDashboardByUIDOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this delete dashboard by Uid o k response has a 3xx status code
func (o *DeleteDashboardByUIDOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete dashboard by Uid o k response has a 4xx status code
func (o *DeleteDashboardByUIDOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete dashboard by Uid o k response has a 5xx status code
func (o *DeleteDashboardByUIDOK) IsServerError() bool {
	return false
}

// IsCode returns true when this delete dashboard by Uid o k response a status code equal to that given
func (o *DeleteDashboardByUIDOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the delete dashboard by Uid o k response
