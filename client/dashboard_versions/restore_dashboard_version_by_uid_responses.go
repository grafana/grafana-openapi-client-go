...
// IsSuccess returns true when this restore dashboard version by Uid o k response has a 2xx status code
func (o *RestoreDashboardVersionByUIDOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this restore dashboard version by Uid o k response has a 3xx status code
func (o *RestoreDashboardVersionByUIDOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this restore dashboard version by Uid o k response has a 4xx status code
func (o *RestoreDashboardVersionByUIDOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this restore dashboard version by Uid o k response has a 5xx status code
func (o *RestoreDashboardVersionByUIDOK) IsServerError() bool {
	return false
}

// IsCode returns true when this restore dashboard version by Uid o k response a status code equal to that given
func (o *RestoreDashboardVersionByUIDOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the restore dashboard version by Uid o k response
