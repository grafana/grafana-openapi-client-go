...
// IsSuccess returns true when this get dashboard permissions list by Uid o k response has a 2xx status code
func (o *GetDashboardPermissionsListByUIDOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get dashboard permissions list by Uid o k response has a 3xx status code
func (o *GetDashboardPermissionsListByUIDOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get dashboard permissions list by Uid o k response has a 4xx status code
func (o *GetDashboardPermissionsListByUIDOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get dashboard permissions list by Uid o k response has a 5xx status code
func (o *GetDashboardPermissionsListByUIDOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get dashboard permissions list by Uid o k response a status code equal to that given
func (o *GetDashboardPermissionsListByUIDOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get dashboard permissions list by Uid o k response
