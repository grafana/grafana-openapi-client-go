...
// IsSuccess returns true when this reload l d a p cfg o k response has a 2xx status code
func (o *ReloadLDAPCfgOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this reload l d a p cfg o k response has a 3xx status code
func (o *ReloadLDAPCfgOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this reload l d a p cfg o k response has a 4xx status code
func (o *ReloadLDAPCfgOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this reload l d a p cfg o k response has a 5xx status code
func (o *ReloadLDAPCfgOK) IsServerError() bool {
	return false
}

// IsCode returns true when this reload l d a p cfg o k response a status code equal to that given
func (o *ReloadLDAPCfgOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the reload l d a p cfg o k response
...
// IsSuccess returns true when this reload l d a p cfg unauthorized response has a 2xx status code
func (o *ReloadLDAPCfgUnauthorized) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this reload l d a p cfg unauthorized response has a 3xx status code
func (o *ReloadLDAPCfgUnauthorized) IsRedirect() bool {
	return false
}

// IsClientError returns true when this reload l d a p cfg unauthorized response has a 4xx status code
func (o *ReloadLDAPCfgUnauthorized) IsClientError() bool {
	return true
}

// IsServerError returns true when this reload l d a p cfg unauthorized response has a 5xx status code
func (o *ReloadLDAPCfgUnauthorized) IsServerError() bool {
	return false
}

// IsCode returns true when this reload l d a p cfg unauthorized response a status code equal to that given
func (o *ReloadLDAPCfgUnauthorized) IsCode(code int) bool {
	return code == 401
}

// Code gets the status code for the reload l d a p cfg unauthorized response
...
// IsSuccess returns true when this reload l d a p cfg forbidden response has a 2xx status code
func (o *ReloadLDAPCfgForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this reload l d a p cfg forbidden response has a 3xx status code
func (o *ReloadLDAPCfgForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this reload l d a p cfg forbidden response has a 4xx status code
func (o *ReloadLDAPCfgForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this reload l d a p cfg forbidden response has a 5xx status code
func (o *ReloadLDAPCfgForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this reload l d a p cfg forbidden response a status code equal to that given
func (o *ReloadLDAPCfgForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the reload l d a p cfg forbidden response
...
// IsSuccess returns true when this reload l d a p cfg internal server error response has a 2xx status code
func (o *ReloadLDAPCfgInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this reload l d a p cfg internal server error response has a 3xx status code
func (o *ReloadLDAPCfgInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this reload l d a p cfg internal server error response has a 4xx status code
func (o *ReloadLDAPCfgInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this reload l d a p cfg internal server error response has a 5xx status code
func (o *ReloadLDAPCfgInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this reload l d a p cfg internal server error response a status code equal to that given
func (o *ReloadLDAPCfgInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the reload l d a p cfg internal server error response
