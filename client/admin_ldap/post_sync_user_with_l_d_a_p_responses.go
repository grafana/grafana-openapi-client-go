...
// IsSuccess returns true when this post sync user with l d a p o k response has a 2xx status code
func (o *PostSyncUserWithLDAPOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this post sync user with l d a p o k response has a 3xx status code
func (o *PostSyncUserWithLDAPOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post sync user with l d a p o k response has a 4xx status code
func (o *PostSyncUserWithLDAPOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this post sync user with l d a p o k response has a 5xx status code
func (o *PostSyncUserWithLDAPOK) IsServerError() bool {
	return false
}

// IsCode returns true when this post sync user with l d a p o k response a status code equal to that given
func (o *PostSyncUserWithLDAPOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the post sync user with l d a p o k response
...
// IsSuccess returns true when this post sync user with l d a p unauthorized response has a 2xx status code
func (o *PostSyncUserWithLDAPUnauthorized) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this post sync user with l d a p unauthorized response has a 3xx status code
func (o *PostSyncUserWithLDAPUnauthorized) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post sync user with l d a p unauthorized response has a 4xx status code
func (o *PostSyncUserWithLDAPUnauthorized) IsClientError() bool {
	return true
}

// IsServerError returns true when this post sync user with l d a p unauthorized response has a 5xx status code
func (o *PostSyncUserWithLDAPUnauthorized) IsServerError() bool {
	return false
}

// IsCode returns true when this post sync user with l d a p unauthorized response a status code equal to that given
func (o *PostSyncUserWithLDAPUnauthorized) IsCode(code int) bool {
	return code == 401
}

// Code gets the status code for the post sync user with l d a p unauthorized response
...
// IsSuccess returns true when this post sync user with l d a p forbidden response has a 2xx status code
func (o *PostSyncUserWithLDAPForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this post sync user with l d a p forbidden response has a 3xx status code
func (o *PostSyncUserWithLDAPForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post sync user with l d a p forbidden response has a 4xx status code
func (o *PostSyncUserWithLDAPForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this post sync user with l d a p forbidden response has a 5xx status code
func (o *PostSyncUserWithLDAPForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this post sync user with l d a p forbidden response a status code equal to that given
func (o *PostSyncUserWithLDAPForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the post sync user with l d a p forbidden response
...
// IsSuccess returns true when this post sync user with l d a p internal server error response has a 2xx status code
func (o *PostSyncUserWithLDAPInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this post sync user with l d a p internal server error response has a 3xx status code
func (o *PostSyncUserWithLDAPInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post sync user with l d a p internal server error response has a 4xx status code
func (o *PostSyncUserWithLDAPInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this post sync user with l d a p internal server error response has a 5xx status code
func (o *PostSyncUserWithLDAPInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this post sync user with l d a p internal server error response a status code equal to that given
func (o *PostSyncUserWithLDAPInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the post sync user with l d a p internal server error response
