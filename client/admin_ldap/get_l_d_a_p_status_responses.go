...
// IsSuccess returns true when this get l d a p status o k response has a 2xx status code
func (o *GetLDAPStatusOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get l d a p status o k response has a 3xx status code
func (o *GetLDAPStatusOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get l d a p status o k response has a 4xx status code
func (o *GetLDAPStatusOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get l d a p status o k response has a 5xx status code
func (o *GetLDAPStatusOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get l d a p status o k response a status code equal to that given
func (o *GetLDAPStatusOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get l d a p status o k response
...
// IsSuccess returns true when this get l d a p status unauthorized response has a 2xx status code
func (o *GetLDAPStatusUnauthorized) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get l d a p status unauthorized response has a 3xx status code
func (o *GetLDAPStatusUnauthorized) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get l d a p status unauthorized response has a 4xx status code
func (o *GetLDAPStatusUnauthorized) IsClientError() bool {
	return true
}

// IsServerError returns true when this get l d a p status unauthorized response has a 5xx status code
func (o *GetLDAPStatusUnauthorized) IsServerError() bool {
	return false
}

// IsCode returns true when this get l d a p status unauthorized response a status code equal to that given
func (o *GetLDAPStatusUnauthorized) IsCode(code int) bool {
	return code == 401
}

// Code gets the status code for the get l d a p status unauthorized response
...
// IsSuccess returns true when this get l d a p status forbidden response has a 2xx status code
func (o *GetLDAPStatusForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get l d a p status forbidden response has a 3xx status code
func (o *GetLDAPStatusForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get l d a p status forbidden response has a 4xx status code
func (o *GetLDAPStatusForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this get l d a p status forbidden response has a 5xx status code
func (o *GetLDAPStatusForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this get l d a p status forbidden response a status code equal to that given
func (o *GetLDAPStatusForbidden) IsCode(code int) bool {
	return code == 403
}

// Code gets the status code for the get l d a p status forbidden response
...
// IsSuccess returns true when this get l d a p status internal server error response has a 2xx status code
func (o *GetLDAPStatusInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get l d a p status internal server error response has a 3xx status code
func (o *GetLDAPStatusInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get l d a p status internal server error response has a 4xx status code
func (o *GetLDAPStatusInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this get l d a p status internal server error response has a 5xx status code
func (o *GetLDAPStatusInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this get l d a p status internal server error response a status code equal to that given
func (o *GetLDAPStatusInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the get l d a p status internal server error response
