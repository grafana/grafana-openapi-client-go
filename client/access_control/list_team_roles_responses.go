...
// IsSuccess returns true when this list team roles o k response has a 2xx status code
func (o *ListTeamRolesOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this list team roles o k response has a 3xx status code
func (o *ListTeamRolesOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list team roles o k response has a 4xx status code
func (o *ListTeamRolesOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this list team roles o k response has a 5xx status code
func (o *ListTeamRolesOK) IsServerError() bool {
	return false
}

// IsCode returns true when this list team roles o k response a status code equal to that given
func (o *ListTeamRolesOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the list team roles o k response
