...
// IsSuccess returns true when this route get alert rule group export o k response has a 2xx status code
func (o *RouteGetAlertRuleGroupExportOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this route get alert rule group export o k response has a 3xx status code
func (o *RouteGetAlertRuleGroupExportOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this route get alert rule group export o k response has a 4xx status code
func (o *RouteGetAlertRuleGroupExportOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this route get alert rule group export o k response has a 5xx status code
func (o *RouteGetAlertRuleGroupExportOK) IsServerError() bool {
	return false
}

// IsCode returns true when this route get alert rule group export o k response a status code equal to that given
func (o *RouteGetAlertRuleGroupExportOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the route get alert rule group export o k response
