...
// IsSuccess returns true when this create library element o k response has a 2xx status code
func (o *CreateLibraryElementOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this create library element o k response has a 3xx status code
func (o *CreateLibraryElementOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create library element o k response has a 4xx status code
func (o *CreateLibraryElementOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this create library element o k response has a 5xx status code
func (o *CreateLibraryElementOK) IsServerError() bool {
	return false
}

// IsCode returns true when this create library element o k response a status code equal to that given
func (o *CreateLibraryElementOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the create library element o k response
