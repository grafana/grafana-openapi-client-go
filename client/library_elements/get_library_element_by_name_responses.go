...
// IsSuccess returns true when this get library element by name o k response has a 2xx status code
func (o *GetLibraryElementByNameOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get library element by name o k response has a 3xx status code
func (o *GetLibraryElementByNameOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get library element by name o k response has a 4xx status code
func (o *GetLibraryElementByNameOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get library element by name o k response has a 5xx status code
func (o *GetLibraryElementByNameOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get library element by name o k response a status code equal to that given
func (o *GetLibraryElementByNameOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get library element by name o k response
