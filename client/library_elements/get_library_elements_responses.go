...
// IsSuccess returns true when this get library elements o k response has a 2xx status code
func (o *GetLibraryElementsOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get library elements o k response has a 3xx status code
func (o *GetLibraryElementsOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get library elements o k response has a 4xx status code
func (o *GetLibraryElementsOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get library elements o k response has a 5xx status code
func (o *GetLibraryElementsOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get library elements o k response a status code equal to that given
func (o *GetLibraryElementsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get library elements o k response
