...
// IsSuccess returns true when this delete library element by Uid o k response has a 2xx status code
func (o *DeleteLibraryElementByUIDOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this delete library element by Uid o k response has a 3xx status code
func (o *DeleteLibraryElementByUIDOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete library element by Uid o k response has a 4xx status code
func (o *DeleteLibraryElementByUIDOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete library element by Uid o k response has a 5xx status code
func (o *DeleteLibraryElementByUIDOK) IsServerError() bool {
	return false
}

// IsCode returns true when this delete library element by Uid o k response a status code equal to that given
func (o *DeleteLibraryElementByUIDOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the delete library element by Uid o k response
