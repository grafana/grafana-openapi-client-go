...
// IsSuccess returns true when this test create recording rule o k response has a 2xx status code
func (o *TestCreateRecordingRuleOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this test create recording rule o k response has a 3xx status code
func (o *TestCreateRecordingRuleOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this test create recording rule o k response has a 4xx status code
func (o *TestCreateRecordingRuleOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this test create recording rule o k response has a 5xx status code
func (o *TestCreateRecordingRuleOK) IsServerError() bool {
	return false
}

// IsCode returns true when this test create recording rule o k response a status code equal to that given
func (o *TestCreateRecordingRuleOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the test create recording rule o k response
