...
// IsSuccess returns true when this create recording rule write target o k response has a 2xx status code
func (o *CreateRecordingRuleWriteTargetOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this create recording rule write target o k response has a 3xx status code
func (o *CreateRecordingRuleWriteTargetOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create recording rule write target o k response has a 4xx status code
func (o *CreateRecordingRuleWriteTargetOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this create recording rule write target o k response has a 5xx status code
func (o *CreateRecordingRuleWriteTargetOK) IsServerError() bool {
	return false
}

// IsCode returns true when this create recording rule write target o k response a status code equal to that given
func (o *CreateRecordingRuleWriteTargetOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the create recording rule write target o k response
