...
// IsSuccess returns true when this send test email o k response has a 2xx status code
func (o *SendTestEmailOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this send test email o k response has a 3xx status code
func (o *SendTestEmailOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this send test email o k response has a 4xx status code
func (o *SendTestEmailOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this send test email o k response has a 5xx status code
func (o *SendTestEmailOK) IsServerError() bool {
	return false
}

// IsCode returns true when this send test email o k response a status code equal to that given
func (o *SendTestEmailOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the send test email o k response
