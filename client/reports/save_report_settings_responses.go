...
// IsSuccess returns true when this save report settings o k response has a 2xx status code
func (o *SaveReportSettingsOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this save report settings o k response has a 3xx status code
func (o *SaveReportSettingsOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this save report settings o k response has a 4xx status code
func (o *SaveReportSettingsOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this save report settings o k response has a 5xx status code
func (o *SaveReportSettingsOK) IsServerError() bool {
	return false
}

// IsCode returns true when this save report settings o k response a status code equal to that given
func (o *SaveReportSettingsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the save report settings o k response
