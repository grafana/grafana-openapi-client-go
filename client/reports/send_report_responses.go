...
// IsSuccess returns true when this send report o k response has a 2xx status code
func (o *SendReportOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this send report o k response has a 3xx status code
func (o *SendReportOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this send report o k response has a 4xx status code
func (o *SendReportOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this send report o k response has a 5xx status code
func (o *SendReportOK) IsServerError() bool {
	return false
}

// IsCode returns true when this send report o k response a status code equal to that given
func (o *SendReportOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the send report o k response
