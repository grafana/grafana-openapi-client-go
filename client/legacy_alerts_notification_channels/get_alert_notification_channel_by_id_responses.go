...
// IsSuccess returns true when this get alert notification channel by Id o k response has a 2xx status code
func (o *GetAlertNotificationChannelByIDOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get alert notification channel by Id o k response has a 3xx status code
func (o *GetAlertNotificationChannelByIDOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get alert notification channel by Id o k response has a 4xx status code
func (o *GetAlertNotificationChannelByIDOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get alert notification channel by Id o k response has a 5xx status code
func (o *GetAlertNotificationChannelByIDOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get alert notification channel by Id o k response a status code equal to that given
func (o *GetAlertNotificationChannelByIDOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get alert notification channel by Id o k response
