...
// IsSuccess returns true when this create alert notification channel o k response has a 2xx status code
func (o *CreateAlertNotificationChannelOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this create alert notification channel o k response has a 3xx status code
func (o *CreateAlertNotificationChannelOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create alert notification channel o k response has a 4xx status code
func (o *CreateAlertNotificationChannelOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this create alert notification channel o k response has a 5xx status code
func (o *CreateAlertNotificationChannelOK) IsServerError() bool {
	return false
}

// IsCode returns true when this create alert notification channel o k response a status code equal to that given
func (o *CreateAlertNotificationChannelOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the create alert notification channel o k response
