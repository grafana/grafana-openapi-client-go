...
// IsSuccess returns true when this delete permissions o k response has a 2xx status code
func (o *DeletePermissionsOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this delete permissions o k response has a 3xx status code
func (o *DeletePermissionsOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this delete permissions o k response has a 4xx status code
func (o *DeletePermissionsOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this delete permissions o k response has a 5xx status code
func (o *DeletePermissionsOK) IsServerError() bool {
	return false
}

// IsCode returns true when this delete permissions o k response a status code equal to that given
func (o *DeletePermissionsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the delete permissions o k response
