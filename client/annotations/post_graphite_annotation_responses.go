...
// IsSuccess returns true when this post graphite annotation o k response has a 2xx status code
func (o *PostGraphiteAnnotationOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this post graphite annotation o k response has a 3xx status code
func (o *PostGraphiteAnnotationOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post graphite annotation o k response has a 4xx status code
func (o *PostGraphiteAnnotationOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this post graphite annotation o k response has a 5xx status code
func (o *PostGraphiteAnnotationOK) IsServerError() bool {
	return false
}

// IsCode returns true when this post graphite annotation o k response a status code equal to that given
func (o *PostGraphiteAnnotationOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the post graphite annotation o k response
