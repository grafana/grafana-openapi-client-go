...
// IsSuccess returns true when this post annotation o k response has a 2xx status code
func (o *PostAnnotationOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this post annotation o k response has a 3xx status code
func (o *PostAnnotationOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this post annotation o k response has a 4xx status code
func (o *PostAnnotationOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this post annotation o k response has a 5xx status code
func (o *PostAnnotationOK) IsServerError() bool {
	return false
}

// IsCode returns true when this post annotation o k response a status code equal to that given
func (o *PostAnnotationOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the post annotation o k response
