...
// IsSuccess returns true when this mass delete annotations o k response has a 2xx status code
func (o *MassDeleteAnnotationsOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this mass delete annotations o k response has a 3xx status code
func (o *MassDeleteAnnotationsOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this mass delete annotations o k response has a 4xx status code
func (o *MassDeleteAnnotationsOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this mass delete annotations o k response has a 5xx status code
func (o *MassDeleteAnnotationsOK) IsServerError() bool {
	return false
}

// IsCode returns true when this mass delete annotations o k response a status code equal to that given
func (o *MassDeleteAnnotationsOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the mass delete annotations o k response
