...
// IsSuccess returns true when this get custom permissions report o k response has a 2xx status code
func (o *GetCustomPermissionsReportOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this get custom permissions report o k response has a 3xx status code
func (o *GetCustomPermissionsReportOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get custom permissions report o k response has a 4xx status code
func (o *GetCustomPermissionsReportOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this get custom permissions report o k response has a 5xx status code
func (o *GetCustomPermissionsReportOK) IsServerError() bool {
	return false
}

// IsCode returns true when this get custom permissions report o k response a status code equal to that given
func (o *GetCustomPermissionsReportOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the get custom permissions report o k response
